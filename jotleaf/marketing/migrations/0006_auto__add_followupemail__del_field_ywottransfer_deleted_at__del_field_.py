...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FollowupEmail'
        db.create_table('marketing_followupemail', (
            ...
            ('subject_template', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('body_template', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('email_json', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('marketing', ['FollowupEmail'])
    ...
    def backwards(self, orm):
        # Deleting model 'FollowupEmail'
        db.delete_table('marketing_followupemail')
    ...
    models = {
        ...
        'marketing.followupemail': {
            'Meta': {'object_name': 'FollowupEmail'},
            'body_template': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'email_json': ('django.db.models.fields.TextField', [], {}),
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'subject_template': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
