...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SentMemberEmail'
        db.create_table(u'main_sentmemberemail', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['main.CustomUser'])),
            ('page', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['main.Page'])),
        ))
        db.send_create_signal(u'main', ['SentMemberEmail'])

        # Adding unique constraint on 'SentMemberEmail', fields ['user', 'page']
        db.create_unique(u'main_sentmemberemail', ['user_id', 'page_id'])

        # Adding unique constraint on 'SentFollowEmail', fields ['user', 'target']
        db.create_unique(u'main_sentfollowemail', ['user_id', 'target_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SentFollowEmail', fields ['user', 'target']
        db.delete_unique(u'main_sentfollowemail', ['user_id', 'target_id'])

        # Removing unique constraint on 'SentMemberEmail', fields ['user', 'page']
        db.delete_unique(u'main_sentmemberemail', ['user_id', 'page_id'])

        # Deleting model 'SentMemberEmail'
        db.delete_table(u'main_sentmemberemail')
    ...
    models = {
        ...
        u'main.sentfollowemail': {
            'Meta': {'unique_together': "[['user', 'target']]", 'object_name': 'SentFollowEmail'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
        ...
        u'main.sentmemberemail': {
            'Meta': {'unique_together': "[['user', 'page']]", 'object_name': 'SentMemberEmail'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
            'id': ('uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'primary_key': 'True'}),
            'page': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['main.Page']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'db_index': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['main.CustomUser']"})
        },
        u'main.textitem': {
