...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.wants_tutorial'
        db.add_column('auth_user', 'wants_tutorial',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.wants_tutorial'
        db.delete_column('auth_user', 'wants_tutorial')
