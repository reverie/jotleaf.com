...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SentFollowEmail'
        db.create_table(u'main_sentfollowemail', (
            ...
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['main.CustomUser'])),
        ))
        db.send_create_signal(u'main', ['SentFollowEmail'])


    def backwards(self, orm):
        # Deleting model 'SentFollowEmail'
        db.delete_table(u'main_sentfollowemail')
