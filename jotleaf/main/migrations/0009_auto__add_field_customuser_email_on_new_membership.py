...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.email_on_new_membership'
        db.add_column('auth_user', 'email_on_new_membership',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.email_on_new_membership'
        db.delete_column('auth_user', 'email_on_new_membership')
    ...
    models = {
        ...
        u'main.customuser': {
            ...
            'email_on_new_membership': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
